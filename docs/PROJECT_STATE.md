...
|-------|-------------|------------|----------------|-------------------|----------------|-------------|
| z-image | ✅ contract tests (adds default aspect_ratio + no-overlay guard) | ☐ | ☐ | ☐ | ☐ | ☐ |
...
- z-image aspect_ratio default now injected even when overlay missing; need createTask/poll validation to mark path green.

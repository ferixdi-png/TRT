...
OPTIONAL_ENV: Tuple[str, ...] = (
    ...
    "WEBHOOK_ACK_MAX_MS",
    "WEBHOOK_URL",
    "START_FALLBACK_MAX_MS",
    "OBS_FLUSH_INTERVAL_MS",
    "OBS_QUEUE_MAX",
    "REDIS_LOCK_CONNECT_TIMEOUT_MS",
    "REDIS_LOCK_MAX_WAIT_MS",
    "TRT_FAULT_INJECT_STORAGE_SLEEP_MS",
    "TRT_FAULT_INJECT_CORR_FLUSH_SLEEP_MS",
    "TRT_FAULT_INJECT_MENU_SLEEP_MS",
    "TRT_FAULT_INJECT_REDIS_CONNECT_SLEEP_MS",

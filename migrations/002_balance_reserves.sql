...
CREATE INDEX IF NOT EXISTS idx_balance_reserves_task_id ON balance_reserves(task_id);
CREATE INDEX IF NOT EXISTS idx_balance_reserves_idempotency_key ON balance_reserves(idempotency_key);
...
-- Таблица для idempotency ключей платежей

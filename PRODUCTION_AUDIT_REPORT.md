...
- Файл: [main_render.py](main_render.py#L6668-L6690) (РЕАЛЬНЫЙ entry point на Render)
- ~~Файл: bot_kie.py:19505-19525~~ (не используется на Render)
- Код:
  ```python
...
**Файлы изменены:**
- [main_render.py](main_render.py#L6668-L6690) (добавлено 28 строк) — **КРИТИЧЕСКИЙ ФИКС**
- ~~[bot_kie.py](bot_kie.py#L19505-L19525)~~ (не используется на Render, убран из деплоя)

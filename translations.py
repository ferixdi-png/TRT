...
TRANSLATIONS = {
    'ru': {
        'welcome_new': (
            '👋 <b>Привет, {name}!</b>\n'
            '🆓 <b>Бесплатные модели</b> доступны прямо сейчас\n'
            'Много нейросетей для фото/видео/аудио/апскейл/удаление фона\n'
            '💳 Оплата в рублях · быстрый результат\n'
            '1️⃣ Выберите модель\n'
            '2️⃣ Введите текст или загрузите файл\n'

...
TRANSLATIONS = {
    'ru': {
        'welcome_new': (
            '🔥 <b>FERIXDI AI</b> — нейро-студия в Telegram\n'
            'Фото / видео / текст / аудио: генерация, апскейл, стили, фон, улучшение качества и другое — всё в одном меню.\n\n'
            '🎛️ Это не лотерея: у моделей есть параметры (формат, качество, детали, референсы), чтобы получать нужный результат.\n\n'
            '🎁 Начни с «БЕСПЛАТНЫЕ МОДЕЛИ» — я дарю тест.\n'

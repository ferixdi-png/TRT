...
TRANSLATIONS = {
    'ru': {
        'welcome_new': (
            '🎨 <b>AI-генератор фото и видео</b>\n\n'
            '🆓 Начни бесплатно — понравится, подключишь премиум\n\n'
            '<b>3 шага:</b> Выбери инструмент → Опиши запрос → Получи результат'
        ),
        'welcome_returning': (
            '🎨 <b>AI-генератор фото и видео</b>\n\n'
            '🆓 Начни бесплатно — понравится, подключишь премиум\n\n'
        ...
        # Buttons
        'btn_generate_free': '🎁 Бесплатно ({remaining}/{total})',  # P1 #3, #39: убрал CAPS
        'btn_generate_free_no_left': '🎁 Бесплатно (0/{total})',  # P1 #3, #39
        'btn_invite_friend': '🎁 Пригласи друга → +{bonus} в free tools обоим!',
        'btn_free_tools': '🆓 Бесплатные инструменты',  # P1 #39: убрал CAPS
        ...
        'error_try_start': '🔄 Сессия истекла. Нажми /start чтобы продолжить',

...
async def main_menu_cb(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    await callback.message.edit_text(
        f"🎨 <b>Главное меню</b>\n\n"
        f"✨ <b>{total_models}+ AI моделей</b> для ваших задач\n\n"
        f"� <b>Категории:</b> Картинки, Видео, Аудио, Улучшение\n"
        f"⭐ <b>Лучшие модели:</b> Топ по качеству и цене\n"
        f"🔍 <b>Поиск:</b> Быстрый поиск по названию\n"
        f"⚡ <b>Быстрые действия:</b> Популярные пресеты\n"
        f"🔥 <b>Trending:</b> Часто выбирают сегодня\n\n"
        f"🆓 Бесплатные модели • 📜 История • 💰 Баланс\n\n"
        f"Выберите действие 👇",
        reply_markup=_main_menu_keyboard(),
    )

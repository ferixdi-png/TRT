...
async def cb_model_details(callback: CallbackQuery, state: FSMContext):
    ...
    category_use_cases = {
        # Task-oriented categories (v3.0)
        "creative": "Создание и редактирование изображений: генерация по описанию, стилизация, улучшение качества. Идеально для баннеров, постов в соцсетях, дизайна, концептов.",
        "music": "Генерация музыки и аудио: создание треков, звуковых эффектов, фоновой музыки. Для видео, подкастов, игр, презентаций.",
        "voice": "Озвучка текста профессиональным голосом. Создание аудиокниг, озвучка видео, генерация диалогов для игр и презентаций.",
        "video": "Генерация и редактирование видео: создание из текста или изображений, анимация статичных картинок. Отлично для Reels, Shorts, рекламных роликов.",
        ...
        "music_legacy": "Генерация музыки. Фоновая музыка для видео, подкастов, презентаций.",
    ...
    example_prompts = {
        # Task-oriented categories (v3.0)
        "creative": "Пример: 'Космонавт на Марсе, фотореализм, закат' или загрузите фото для улучшения",
        "music": "Пример: 'спокойная фоновая музыка для видео, ambient' или 'энергичный рок-трек'",
        "voice": "Пример: Введите текст → 'Добро пожаловать в нашу компанию. Мы рады представить новый продукт.'",
        "video": "Пример: 'Кот играет с клубком шерсти, замедленная съемка' или загрузите картинку для анимации",
        # Legacy categories
